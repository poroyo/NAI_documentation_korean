...
그리고 이 모듈의 독특한 점은 이것을 사용하기 위해 모듈 리스트에서 선택할 필요가 없다는 것입니다. 컨텍스트의 최근 *1000자 이내*의 지시사항을 입력하기만 하면 모델은 출력을 위해 자동으로 **Instruct Module**을 사용합니다!
...
메모리나 작가노트에서의 { 한칸 띄어쓰기한 중괄호 } 사이의 지시사항은, 지시사항이 컨텍스트 범위 내의 *~1000자*에 있는 한, Instruct Module를 자동으로 활성화하는데에 사용할 수도 있습니다.
...
모듈을 선택만 하면 되기 때문에 **Instruct**보다는 사용하기 쉽습니다.
